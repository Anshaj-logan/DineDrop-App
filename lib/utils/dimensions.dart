...
class Dimensions {
  ...
  static double height70 = screenHeight / 11.2;
  ...
  //list view size
  static double listViewImgSize = screenWidth / 6.53;
  static double listViewTextContSize = screenWidth / 7.84;

  //popular food
  static double popularFoodImageSize = screenHeight / 2.24;
